...
При выполнении задания color-switch игнорируется условие, согласно которому пока
изменение темы запушено, кнопка Start должна быть не активна (для реализации
этого задания вам очень пригодится атрибут disabled). setAttribute("disabled",
"disabled");
